...
const firebaseConfig = {
    apiKey: "AIzaSyAg3aKhX4gqBzd9yCt1gwViO8w_f6wZHKs",
    authDomain: "food-dhaba-8bd43.firebaseapp.com",
    projectId: "food-dhaba-8bd43",
    storageBucket: "food-dhaba-8bd43.firebasestorage.app",
    messagingSenderId: "610529307617",
    appId: "1:610529307617:web:a92002a2e27cdf55b300a0",
    measurementId: "G-4V2BVB90V7"
  };
...
async function getProductList() {
    ...
    querySnapshot.forEach((doc) => {
        ...
        <div class="card-body">
            ...
            <button onclick='openEditModal("${doc.id}", "${doc.data().product_name}", "${doc.data().product_price}", "${doc.data().product_des}", "${doc.data().product_url}")' class='btn btn-info'> Edit </button>
...
async function userData() {
    ...
    querySnapshot.forEach((doc) => {
        ...
        <button onclick='addtocart("${doc.id}", "${doc.data().product_name}", "${doc.data().product_price}", "${doc.data().product_des}", "${doc.data().product_url}")' class='btn btn-primary'> Add to Cart </button>
    </div>`;
    });
}
if (userDiv) {
